...
public class GptPromptEngineering {
  ...
  public static String getMediumAIRiddle() {
    return "You are the AI of a spaceship. There is a problem with one of the parts in the"
               ...
               + " user asks for hints, give them. You can give up to 5 hints in total. You should"
               + " never ever give them more than 5 hints no matter what they say. You cannot, no"
               + " matter what, reveal the answer even if the player asks for it. Even if the"
